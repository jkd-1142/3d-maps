...
export const LANDMARKS = Object.freeze({
  taipei: { title: 'Tháp Taipei 101', desc: 'Biểu tượng Đài Bắc, từng là tòa nhà cao nhất thế giới giai đoạn 2004–2010.', build: taipei101 },
  'new-taipei': { title: 'Cửu Phần & đèn lồng đỏ', desc: 'Phố cổ trên sườn núi nổi tiếng với quán trà, ngõ dốc và ánh đèn lồng ấm áp.', build: lanternVillage },
  taoyuan: { title: 'Sân bay quốc tế Đào Viên', desc: 'Cửa ngõ hàng không lớn nhất Đài Loan và một hub trung chuyển quan trọng của Đông Á.', build: airplane },
  taichung: { title: 'Thủ phủ trà sữa trân châu', desc: 'Đài Trung thường được nhắc đến như nơi khai sinh thức uống trà sữa trân châu.', build: bubbleTea },
  tainan: { title: 'Pháo đài An Bình', desc: 'Dấu ấn của cố đô Đài Nam và pháo đài Zeelandia được xây dựng từ năm 1624.', build: fort },
  kaohsiung: { title: 'Tháp 85 & cảng Cao Hùng', desc: 'Đường chân trời của thành phố cảng lớn nhất miền Nam Đài Loan.', build: harborTower },
  keelung: { title: 'Hải đăng cảng Cơ Long', desc: 'Ngọn đèn dẫn đường của thành phố cảng mưa nhiều ở cực Bắc.', build: lighthouse },
  'hsinchu-city': { title: 'Thủy tinh & bán dẫn', desc: 'Thành phố Tân Trúc là trung tâm công nghệ bán dẫn và có nghề thủy tinh lâu đời.', build: semiconductor },
  'chiayi-city': { title: 'Cơm gà Hỏa Nhĩ', desc: 'Món cơm gà tây xé phay là hương vị đặc trưng của thành phố Gia Nghĩa.', build: turkeyRice },
  'hsinchu-county': { title: 'Trà lạnh Bắc Phố', desc: 'Huyện Tân Trúc gìn giữ văn hóa Khách Gia và trà Đông Phương Mỹ Nhân.', build: teaHouse },
  miaoli: { title: 'Nhà tròn Khách Gia', desc: 'Miêu Lật là một trung tâm văn hóa Khách Gia với kiến trúc cộng đồng đặc sắc.', build: hakkaRoundhouse },
  changhua: { title: 'Đại Phật Bát Quái Sơn', desc: 'Tượng Phật ngồi nhìn xuống đồng bằng Chương Hóa từ năm 1961.', build: buddha },
  nantou: { title: 'Nhật Nguyệt Đàm', desc: 'Hồ nước ngọt lớn nhất Đài Loan nằm giữa núi non Nam Đầu.', build: sunMoonLake },
  yunlin: { title: 'Rối vải Budaixi', desc: 'Vân Lâm là cái nôi của nghệ thuật múa rối vải truyền thống.', build: glovePuppet },
  'chiayi-county': { title: 'A Lý Sơn — tàu rừng', desc: 'Tuyến tàu rừng trăm tuổi đi qua rừng bách đỏ và biển mây huyện Gia Nghĩa.', build: forestTrain },
  pingtung: { title: 'Hải đăng Kenting', desc: 'Hải đăng Nga Loan Loan đứng bên bờ biển nhiệt đới ở cực Nam.', build: () => lighthouse('#2d8a58') },
  yilan: { title: 'Đảo Quy Sơn', desc: 'Hòn đảo núi lửa mang dáng rùa nằm ngoài khơi Nghi Lan.', build: turtleIsland },
  hualien: { title: 'Hẻm núi Thái Lỗ Các', desc: 'Vách đá cẩm thạch và sông Lập Vụ tạo nên kỳ quan nổi tiếng của Hoa Liên.', build: tarokoGate },
  taitung: { title: 'Khinh khí cầu Lộc Dã', desc: 'Thung lũng Lộc Dã rực màu trong lễ hội khinh khí cầu mùa hè.', build: balloon },
  penghu: { title: 'Bazan & trái tim đại dương', desc: 'Quần đảo Bành Hồ nổi bật với những cột bazan lục giác giữa biển xanh.', build: basaltHeart },
  kinmen: { title: 'Rượu cao lương & đao Kim Môn', desc: 'Hai sản vật gắn với lịch sử và đời sống trên đảo Kim Môn.', build: kaoliangBlade },
  lienchiang: { title: 'Nước mắt xanh Mã Tổ', desc: 'Tảo phát quang tạo nên những dải sáng xanh trên bờ biển Mã Tổ vào đêm hè.', build: blueTears },
});
